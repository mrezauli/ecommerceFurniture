    ...
    <div class="product-block">
        ...
        <div style="position: fixed; z-index: 111; right: 30px">
            ...
            <?php
                ...
                $_products_info = $_all_products->index();
                    ...
                    <div class="col-md-3 product-grid">
                        <div class="product-items">
                            ...
                            <div class="produ-cost">
                                ...
                                <td>
                                    <a class="text-danger" href="view/admin/Products/view.php?uid=<?php echo $_product['unique_id']?>">View</a> |
                                    <a class="text-danger" href="view/admin/Products/edit.php?uid=<?php echo $_product['unique_id']?>">Update</a> |
                                    <a class="text-danger" href="view/admin/Products/temp_delete.php?uid=<?php echo $_product['unique_id']?>">Delete</a>
                                </td>
                            </div>
                        </div>
                    </div>
