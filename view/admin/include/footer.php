        ...
        <ul id="menu" >
            ...
            <li><a href="#"><i class="fa fa-shopping-cart"></i><span>Products</span><span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="view/admin/products/create.php">Add</a></li>
                    <li id="menu-academico-boletim" ><a href="view/admin/products/index.php">View</a></li>
                    <li id="menu-academico-boletim" ><a href="view/admin/products/new.php">New</a></li>
                    <li id="menu-academico-boletim" ><a href="view/admin/products/trash.php">Trash</a></li>
                    <li id="menu-academico-boletim" ><a href="view/admin/products/orders.php">Orders</a></li>
                </ul>
            </li>
