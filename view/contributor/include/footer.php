        ...
        <ul id="menu" >
            ...
            <li><a href="#"><i class="fa fa-shopping-cart"></i><span>Products</span><span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="view/contributor/products/create.php">Add</a></li>
                    <li id="menu-academico-boletim" ><a href="view/contributor/index.php">View</a></li>
                </ul>
            </li>
