...
<title>Shoppy an Admin Panel Category Flat Bootstrap Responsive Website Template | Signup :: w3layouts</title>
	...
	<base href="http://localhost/ecommerceFurniture/">
    	 ...
    	 <div class="signup-head">
			...
			<div class="signup-block">
				<form action="" method="post">
                    ...
                    <input type="hidden" name="is_user" value="1" class="lock" style="display: inline">
				...
				<div class="sign-down">
				<h4>Already have an account? <a href="view/front/auth/login.php"> Login here.</a></h4>
